...
@section('title', 'Chỉnh sửa địa chỉ - Aosomi')
@section('page-title', 'Chỉnh sửa địa chỉ')

@section('content')
<!-- Hero Section -->
<div class="hero-section">
    <div class="container text-center">
        <h1 class="display-4 fw-bold mb-4">Chỉnh sửa địa chỉ</h1>
        <p class="lead">Cập nhật thông tin địa chỉ của bạn</p>
    </div>
</div>
                    ...
                    <form method="POST" action="{{ route('addresses.update', $address) }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type" id="home" 
                                               value="home" {{ old('type', $address->type) == 'home' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type" id="office" 
                                               value="office" {{ old('type', $address->type) == 'office' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type" id="other" 
                                               value="other" {{ old('type', $address->type) == 'other' ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" 
                                      ...
                                      placeholder="Số nhà, tên đường, tên khu phố...">{{ old('address', $address->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="card mt-3">
                <div class="card-body">
                    <h6 class="text-primary mb-3">
                        <i class="fas fa-info-circle me-2"></i>Thông tin địa chỉ hiện tại
                    </h6>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-2">
                                <strong>Tên:</strong> {{ $address->name }}
                            </div>
                            <div class="mb-2">
                                <strong>Số điện thoại:</strong> {{ $address->phone }}
                            </div>
                            <div class="mb-2">
                                <strong>Loại:</strong> {{ $address->type_name }}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-2">
                                <strong>Địa chỉ:</strong> {{ $address->full_address }}
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <strong>Ngày tạo:</strong> {{ $address->created_at->format('d/m/Y H:i') }}
                            </div>
                        </div>
                    </div>
                </div>
